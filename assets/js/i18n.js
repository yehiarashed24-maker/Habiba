...
const translations = {
  en: {
    ...
    studio_save_modal_title: "Your Masterpiece",
    studio_save_modal_hint: "Long-press the image to save to your Photos, or tap Share below.",
    studio_save_btn_share: "Share / Save to Photos",
    studio_save_btn_direct: "Direct Download",
    studio_close: "Close",
    ...
    about_p1: "18-year-old artist and engineering student, trained in Cairo, Rome, and Spain (Gravura Taller de Grabado) under Donzi El Housieny, Donzi Art Academy, Dr. Mourad Darwish, Dr. Ahmed Badawy, Galal Gomaa, Massimiliano Locco, Merima Fetahovic, and Dr. Nasser Elgilani.",
    ...
    contact_addr_title: "LOCATION",
    contact_addr_val: "Egypt",
  ...
  ar: {
    ...
    studio_save_modal_title: "لوحتك الفنية جاهزة!",
    studio_save_modal_hint: "اضغط مطولاً على الصورة لحفظها في ألبوم الصور، أو اضغط مشاركة بالأسفل.",
    studio_save_btn_share: "مشاركة / حفظ في الصور",
    studio_save_btn_direct: "تحميل مباشر",
    studio_close: "إغلاق",
    ...
    about_num: "٠١",
    about_title: "من أنا",
    about_p1: "فنانة تبلغ من العمر ١٨ عاماً وطالبة هندسة، تدربت في القاهرة وروما وإسبانيا (Gravura Taller de Grabado) تحت إشراف دونزي الحسيني وأكاديمية دونزي للفنون (Donzi Art Academy)، ود. مراد درويش، د. أحمد بدوي، جلال جمعة، ماسيميليانو لوكو، ميريما فيتاهوفيتش، ود. ناصر الجيلاني.",
    ...
    contact_addr_title: "الموقع",
    contact_addr_val: "مصر",
